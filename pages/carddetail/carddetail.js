...
Page({
  ...
  onShareAppMessage: function() {
    ...
    return {
      ...
      success: (res) => {
        ...
        app.userLog(that.data.cardDetail.PCardID, 202)
      },
      fail: (res) => {
    ...
    wx.makePhoneCall({
      ...
      success(res) {
        if (res.errMsg == 'makePhoneCall:ok') {
          app.userLog(that.data.cardDetail.PCardID, event.currentTarget.dataset.phoneid)
        }
      }
    });
  },
    ...
    wx.setClipboardData({
      ...
      success(res) {
        ...
        if (res.errMsg == 'setClipboardData:ok') {
          app.userLog(that.data.cardDetail.PCardID, id)
        }
      }
    });
  },
  ...
  tapAddPhoneContact: function() {
    ...
    app.userLog(that.data.cardDetail.PCardID, 203)
  },
